...
int main(int argc, char *argv[]) 
{
  ...
  stRgaAttr.stImgIn.u32X = 756;
  stRgaAttr.stImgIn.u32Y = 12;
  stRgaAttr.stImgIn.imgType = IMAGE_TYPE_NV12;
  stRgaAttr.stImgIn.u32Width = 1080;
  stRgaAttr.stImgIn.u32Height = 1920;
  stRgaAttr.stImgIn.u32HorStride = 1080;
  stRgaAttr.stImgIn.u32VirStride = 1920;
  ...
  case RK_CODEC_TYPE_H265:
    ...
    venc_chn_attr.stRcAttr.stH265Cbr.u32BitRate = disp_width * disp_height;
